...
public abstract class Evaluator {
    ...
    public static final class C1062Id extends Evaluator {

        /* renamed from: id */
        private String f945id;

        public C1062Id(String id) {
            this.f945id = id;
        }

        public boolean matches(Element root, Element element) {
            return this.f945id.equals(element.mo13114id());
        }

        public String toString() {
            return String.format("#%s", new Object[]{this.f945id});
        }
    }
    ...
    public static abstract class CssNthEvaluator extends Evaluator {
        ...
        public boolean matches(Element root, Element element) {
            ...
            if (this.f943a == 0) {
                ...
                return true;
            } else if ((pos - this.f944b) * this.f943a < 0 || (pos - this.f944b) % this.f943a != 0) {
                return false;
            } else {
                return true;
            }
        ...
        public String toString() {
            if (this.f943a == 0) {
                return String.format(":%s(%d)", new Object[]{getPseudoClass(), Integer.valueOf(this.f944b)});
            } else if (this.f944b == 0) {
                return String.format(":%s(%dn)", new Object[]{getPseudoClass(), Integer.valueOf(this.f943a)});
            } else {
                return String.format(":%s(%dn%+d)", new Object[]{getPseudoClass(), Integer.valueOf(this.f943a), Integer.valueOf(this.f944b)});
            }
        }
    }
