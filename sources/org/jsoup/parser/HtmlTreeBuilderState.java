...
enum HtmlTreeBuilderState {
        ...
        public boolean process(Token t, HtmlTreeBuilder tb) {
            ...
            if (t.isComment()) {
                ...
                if (!t.isStartTag() || !t.asStartTag().name().equals("html")) {
                    if (t.isEndTag()) {
                        if (StringUtil.m203in(t.asEndTag().name(), "head", "body", "html", "br")) {
        ...
        public boolean process(Token t, HtmlTreeBuilder tb) {
            ...
            switch (t.type) {
                ...
                case StartTag:
                    ...
                    if (StringUtil.m203in(name, "base", "basefont", "bgsound", "command", "link")) {
                        ...
                        if (StringUtil.m203in(name, "noframes", "style")) {
                ...
                case EndTag:
                    ...
                    if (StringUtil.m203in(name2, "body", "html", "br")) {
                        return anythingElse(t, tb);
                    }
                    tb.error(this);
                    return false;
    ...
    InHeadNoscript {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:0x0086, code lost:
            if (org.jsoup.helper.StringUtil.m203in(r8.asStartTag().name(), "basefont", "bgsound", "link", "meta", "noframes", "style") != false) goto L_0x0088;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:31:0x00c8, code lost:
            if (org.jsoup.helper.StringUtil.m203in(r8.asStartTag().name(), "head", "noscript") == false) goto L_0x00ca;
         */
        ...
        public boolean process(org.jsoup.parser.Token r8, org.jsoup.parser.HtmlTreeBuilder r9) {
            ...
            L_0x004a:
                ...
                r3[r4] = r5
                boolean r2 = org.jsoup.helper.StringUtil.m203in(r2, r3)
                if (r2 == 0) goto L_0x0090
            L_0x0088:
                org.jsoup.parser.HtmlTreeBuilderState r0 = InHead
                boolean r0 = r9.process(r8, r0)
            ...
            L_0x00ac:
                ...
                r3[r1] = r4
                boolean r1 = org.jsoup.helper.StringUtil.m203in(r2, r3)
            ...
            L_0x00d5:
                ...
                goto L_0x000d
            */
            throw new UnsupportedOperationException("Method not decompiled: org.jsoup.parser.HtmlTreeBuilderState.C09865.process(org.jsoup.parser.Token, org.jsoup.parser.HtmlTreeBuilder):boolean");
        }
        ...
        public boolean process(Token t, HtmlTreeBuilder tb) {
            if (HtmlTreeBuilderState.isWhitespace(t)) {
                ...
                if (name.equals("body")) {
                    ...
                    if (StringUtil.m203in(name, "base", "basefont", "bgsound", "link", "meta", "noframes", "script", "style", "title")) {
                        tb.error(this);
                ...
                if (StringUtil.m203in(t.asEndTag().name(), "body", "html")) {
                    anythingElse(t, tb);
                } else {
                    tb.error(this);
                    return false;
    ...
    InBody {
        ...
        public boolean process(org.jsoup.parser.Token r43, org.jsoup.parser.HtmlTreeBuilder r44) {
            /*
                r42 = this;
                int[] r39 = org.jsoup.parser.HtmlTreeBuilderState.C098324.$SwitchMap$org$jsoup$parser$Token$TokenType
                r0 = r43
            ...
            L_0x00be:
                ...
                r0 = r26
                r1 = r39
                boolean r39 = org.jsoup.helper.StringUtil.m203in(r0, r1)
            ...
            L_0x0249:
                ...
                boolean r39 = org.jsoup.helper.StringUtil.m203in(r39, r40)
            ...
            L_0x0e38:
                ...
                goto L_0x0013
            */
            throw new UnsupportedOperationException("Method not decompiled: org.jsoup.parser.HtmlTreeBuilderState.C09887.process(org.jsoup.parser.Token, org.jsoup.parser.HtmlTreeBuilder):boolean");
        }
    ...
    InTable {
        ...
        public boolean process(Token t, HtmlTreeBuilder tb) {
            if (t.isCharacter()) {
                ...
                if (name.equals("caption")) {
                    ...
                    if (StringUtil.m203in(name, "tbody", "tfoot", "thead")) {
                        tb.clearStackToTableContext();
                        tb.insert(startTag);
                        tb.transition(InTableBody);
                        return true;
                    }
                    if (StringUtil.m203in(name, "td", "th", "tr")) {
                        ...
                        if (StringUtil.m203in(name, "style", "script")) {
                ...
                if (!name2.equals("table")) {
                    if (!StringUtil.m203in(name2, "body", "caption", "col", "colgroup", "html", "tbody", "td", "tfoot", "th", "thead", "tr")) {
                        return anythingElse(t, tb);
                    }
                    tb.error(this);
                    return false;
        ...
        public boolean anythingElse(Token t, HtmlTreeBuilder tb) {
            tb.error(this);
            if (!StringUtil.m203in(tb.currentElement().nodeName(), "table", "tbody", "tfoot", "thead", "tr")) {
                return tb.process(t, InBody);
            }
    ...
    InTableText {
        /* access modifiers changed from: package-private */
        public boolean process(Token t, HtmlTreeBuilder tb) {
            switch (C098324.$SwitchMap$org$jsoup$parser$Token$TokenType[t.type.ordinal()]) {
                case 5:
    ...
    InCaption {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x0091, code lost:
            if (org.jsoup.helper.StringUtil.m203in(r13.asStartTag().name(), "caption", "col", "colgroup", "tbody", "td", "tfoot", "th", "thead", "tr") == false) goto L_0x0093;
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public boolean process(org.jsoup.parser.Token r13, org.jsoup.parser.HtmlTreeBuilder r14) {
            ...
            L_0x0052:
                ...
                r6[r7] = r8
                boolean r5 = org.jsoup.helper.StringUtil.m203in(r5, r6)
            ...
            L_0x00bf:
                ...
                r6[r4] = r7
                boolean r4 = org.jsoup.helper.StringUtil.m203in(r5, r6)
            ...
            L_0x010b:
                ...
                goto L_0x002c
            */
            throw new UnsupportedOperationException("Method not decompiled: org.jsoup.parser.HtmlTreeBuilderState.C096911.process(org.jsoup.parser.Token, org.jsoup.parser.HtmlTreeBuilder):boolean");
        }
    },
    InColumnGroup {
        /* access modifiers changed from: package-private */
            ...
            switch (C098324.$SwitchMap$org$jsoup$parser$Token$TokenType[t.type.ordinal()]) {
                case 3:
                    ...
                    if (name.equals("tr")) {
                        ...
                        if (StringUtil.m203in(name, "th", "td")) {
                            tb.error(this);
                            tb.process(new Token.StartTag("tr"));
                            return tb.process(startTag);
                        }
                        if (StringUtil.m203in(name, "caption", "col", "colgroup", "tbody", "tfoot", "thead")) {
                ...
                case 4:
                    String name2 = t.asEndTag().name();
                    if (StringUtil.m203in(name2, "tbody", "tfoot", "thead")) {
                        ...
                        if (!StringUtil.m203in(name2, "body", "caption", "col", "colgroup", "html", "td", "th", "tr")) {
                            return anythingElse(t, tb);
                        }
                        tb.error(this);
                        return false;
        ...
        public boolean process(Token t, HtmlTreeBuilder tb) {
            if (t.isStartTag()) {
                ...
                if (StringUtil.m203in(name, "th", "td")) {
                    ...
                    if (StringUtil.m203in(name, "caption", "col", "colgroup", "tbody", "tfoot", "thead", "tr")) {
                ...
                if (name2.equals("tr")) {
                    ...
                    if (!StringUtil.m203in(name2, "tbody", "tfoot", "thead")) {
                        if (!StringUtil.m203in(name2, "body", "caption", "col", "colgroup", "html", "td", "th")) {
                            return anythingElse(t, tb);
                        }
                        tb.error(this);
                        return false;
    ...
    InCell {
        ...
        public boolean process(Token t, HtmlTreeBuilder tb) {
            if (t.isEndTag()) {
                String name = t.asEndTag().name();
                if (!StringUtil.m203in(name, "td", "th")) {
                    if (StringUtil.m203in(name, "body", "caption", "col", "colgroup", "html")) {
                        tb.error(this);
                        return false;
                    }
                    if (!StringUtil.m203in(name, "table", "tbody", "tfoot", "thead", "tr")) {
                        return anythingElse(t, tb);
                    }
                ...
                if (t.isStartTag()) {
                    if (StringUtil.m203in(t.asStartTag().name(), "caption", "col", "colgroup", "tbody", "td", "tfoot", "th", "thead", "tr")) {
            ...
            switch (C098324.$SwitchMap$org$jsoup$parser$Token$TokenType[t.type.ordinal()]) {
                ...
                case 3:
                    ...
                    if (name.equals("option")) {
                        ...
                        if (StringUtil.m203in(name, "input", "keygen", "textarea")) {
                            tb.error(this);
    ...
    InSelectInTable {
        ...
        public boolean process(Token t, HtmlTreeBuilder tb) {
            if (t.isStartTag()) {
                if (StringUtil.m203in(t.asStartTag().name(), "caption", "table", "tbody", "tfoot", "thead", "tr", "td", "th")) {
                    tb.error(this);
                    tb.process(new Token.EndTag("select"));
                    return tb.process(t);
                }
            ...
            if (t.isEndTag()) {
                if (StringUtil.m203in(t.asEndTag().name(), "caption", "table", "tbody", "tfoot", "thead", "tr", "td", "th")) {
                    tb.error(this);
