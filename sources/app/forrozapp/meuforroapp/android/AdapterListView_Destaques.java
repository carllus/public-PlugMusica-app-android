...
public class AdapterListView_Destaques extends BaseAdapter {
    Context context;
    private List<ItemListView> itens;
    private LayoutInflater mInflater;

    public AdapterListView_Destaques(Context context2, List<ItemListView> itens2) {
        this.itens = itens2;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            view = this.mInflater.inflate(R.layout.item_list_destaque, (ViewGroup) null);
