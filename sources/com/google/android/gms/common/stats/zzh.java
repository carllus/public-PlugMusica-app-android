...
public class zzh {
    ...
    /* renamed from: EH */
    private static zzh f472EH = new zzh();

    /* renamed from: EI */
    private static Boolean f473EI;
    ...
    private static boolean zzcj(Context context) {
        if (f473EI == null) {
            f473EI = Boolean.valueOf(zzck(context));
        }
        return f473EI.booleanValue();
    }
    ...
    private static boolean zzck(Context context) {
        try {
            ...
            return zzc.zzb.f459Eh.get().intValue() != zzd.LOG_LEVEL_OFF;
    ...
    public void zza(Context context, String str, int i, String str2, String str3, String str4, int i2, List<String> list, long j) {
        if (zzcj(context)) {
            ...
            if (7 == i || 8 == i || 10 == i || 11 == i) {
                try {
                    context.startService(new Intent().setComponent(zzd.f461En).putExtra("com.google.android.gms.common.stats.EXTRA_LOG_EVENT", new WakeLockEvent(currentTimeMillis, i, str2, i2, zzf.zzz(list), str, SystemClock.elapsedRealtime(), zzj.zzcn(context), str3, zzf.zzih(context.getPackageName()), zzj.zzco(context), j, str4)));
                } catch (Exception e) {
                    Log.wtf(TAG, e);
                }
            }
