...
public interface zzy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzy {
        ...
        private static class C1105zza implements zzy {
            private IBinder zzajf;

            C1105zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzy zzdy(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzy)) ? new C1105zza(iBinder) : (zzy) queryLocalInterface;
        }
