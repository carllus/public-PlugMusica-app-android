...
public interface zzt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzt {
        ...
        private static class C1100zza implements zzt {
            private IBinder zzajf;

            C1100zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzt zzdt(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzt)) ? new C1100zza(iBinder) : (zzt) queryLocalInterface;
        }
