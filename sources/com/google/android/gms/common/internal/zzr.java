...
public interface zzr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzr {
        ...
        private static class C1098zza implements zzr {
            private IBinder zzajf;

            C1098zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzr zzdr(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzr)) ? new C1098zza(iBinder) : (zzr) queryLocalInterface;
        }
