...
public interface zzw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzw {
        ...
        private static class C1103zza implements zzw {
            private IBinder zzajf;

            C1103zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzw zzdw(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzw)) ? new C1103zza(iBinder) : (zzw) queryLocalInterface;
        }
