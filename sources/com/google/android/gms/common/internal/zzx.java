...
public interface zzx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzx {
        ...
        private static class C1104zza implements zzx {
            private IBinder zzajf;

            C1104zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzx zzdx(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzx)) ? new C1104zza(iBinder) : (zzx) queryLocalInterface;
        }
