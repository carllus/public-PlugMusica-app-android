...
public interface zzu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzu {
        ...
        private static class C1101zza implements zzu {
            private IBinder zzajf;

            C1101zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzu zzdu(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzu)) ? new C1101zza(iBinder) : (zzu) queryLocalInterface;
        }
