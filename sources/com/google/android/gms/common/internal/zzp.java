...
public class zzp {
    ...
    /* renamed from: CM */
    private static final Uri f384CM = Uri.parse("http://plus.google.com/");

    /* renamed from: CN */
    private static final Uri f385CN = f384CM.buildUpon().appendPath("circles").appendPath("find").build();
