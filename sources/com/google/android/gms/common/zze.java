...
public class zze {
    ...
    /* renamed from: uX */
    public static boolean f508uX = false;

    /* renamed from: uY */
    public static boolean f509uY = false;

    /* renamed from: uZ */
    static boolean f510uZ = false;

    /* renamed from: va */
    private static String f511va = null;

    /* renamed from: vb */
    private static int f512vb = 0;

    /* renamed from: vc */
    private static boolean f513vc = false;

    /* renamed from: vd */
    static final AtomicBoolean f514vd = new AtomicBoolean();

    /* renamed from: ve */
    private static final AtomicBoolean f515ve = new AtomicBoolean();
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C0417R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
        ...
        try {
            ...
            if (z) {
                zzd.zza zza = zzbz.zza(packageInfo, zzd.C1106zzd.f507uW);
                if (zza == null) {
            ...
            } else if (zzbz.zza(packageInfo2, zzd.C1106zzd.f507uW) == null) {
                Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                return 9;
            }
    ...
    private static void zzbt(Context context) {
        if (!f515ve.get()) {
            ...
            } else if (f512vb != GOOGLE_PLAY_SERVICES_VERSION_CODE) {
    ...
    private static void zzby(Context context) {
        try {
            f511va = context.getPackageName();
            zzsh zzcr = zzsi.zzcr(context);
            f512vb = zzaa.zzch(context);
            PackageInfo packageInfo = zzcr.getPackageInfo("com.google.android.gms", 64);
            if (packageInfo != null) {
                if (zzf.zzbz(context).zza(packageInfo, zzd.C1106zzd.f507uW[1]) != null) {
                    f510uZ = true;
                }
            }
            f510uZ = false;
