...
public class zzz {
    ...
    /* renamed from: Fa */
    private static final Method f491Fa = zzaya();

    /* renamed from: Fb */
    private static final Method f492Fb = zzayb();

    /* renamed from: Fc */
    private static final Method f493Fc = zzayc();

    /* renamed from: Fd */
    private static final Method f494Fd = zzayd();

    /* renamed from: Fe */
    private static final Method f495Fe = zzaye();

    public static int zza(WorkSource workSource) {
        if (f493Fc != null) {
            try {
                return ((Integer) f493Fc.invoke(workSource, new Object[0])).intValue();
            } catch (Exception e) {
    ...
    public static String zza(WorkSource workSource, int i) {
        if (f495Fe != null) {
            try {
                return (String) f495Fe.invoke(workSource, new Object[]{Integer.valueOf(i)});
            } catch (Exception e) {
                Log.wtf("WorkSourceUtil", "Unable to assign blame through WorkSource", e);
            }
        }
    ...
    public static void zza(WorkSource workSource, int i, String str) {
        if (f492Fb != null) {
            ...
            try {
                f492Fb.invoke(workSource, new Object[]{Integer.valueOf(i), str});
            } catch (Exception e) {
                Log.wtf("WorkSourceUtil", "Unable to assign blame through WorkSource", e);
            }
        } else if (f491Fa != null) {
            try {
                f491Fa.invoke(workSource, new Object[]{Integer.valueOf(i)});
            } catch (Exception e2) {
