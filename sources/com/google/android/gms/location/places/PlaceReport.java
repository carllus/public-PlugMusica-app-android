...
public class PlaceReport extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public boolean equals(Object obj) {
        ...
        return zzab.equal(this.aiY, placeReport.aiY) && zzab.equal(this.mTag, placeReport.mTag) && zzab.equal(this.f893I, placeReport.f893I);
    }
    ...
    public int hashCode() {
        return zzab.hashCode(this.aiY, this.mTag, this.f893I);
    }
    ...
    public String toString() {
        ...
        if (!EnvironmentCompat.MEDIA_UNKNOWN.equals(this.f893I)) {
            zzx.zzg("source", this.f893I);
        }
        return zzx.toString();
    }
