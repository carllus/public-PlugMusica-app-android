...
public class zzl {
    public static boolean zza(PublicKey publicKey, String str, String str2) {
        try {
            ...
            zzkn.m25e("Signature verification failed.");
            return false;
        } catch (NoSuchAlgorithmException e) {
            zzkn.m25e("NoSuchAlgorithmException.");
            return false;
        } catch (InvalidKeyException e2) {
            zzkn.m25e("Invalid key specification.");
            return false;
        } catch (SignatureException e3) {
            zzkn.m25e("Signature exception.");
            return false;
        }
    }
    ...
    public static boolean zzc(String str, String str2, String str3) {
        ...
        zzkn.m25e("Purchase verification failed: missing data.");
        return false;
    }
