...
public class zzc extends zzi implements AudioManager.OnAudioFocusChangeListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, TextureView.SurfaceTextureListener {
    ...
    private void zzoh() {
        ...
        zzkn.m162v("AdMediaPlayerView init MediaPlayer");
    ...
    private void zzoi() {
        ...
        L_0x0005:
            ...
            com.google.android.gms.internal.zzkn.m162v(r0)
            r0 = 0
            r8.zzb(r0)
            android.media.MediaPlayer r0 = r8.zzbwn
            r0.start()
    ...
    private void zzok() {
        zzkn.m162v("AdMediaPlayerView abandon audio focus");
        AudioManager zzor = zzor();
        if (zzor != null && this.zzbww) {
    ...
    private void zzoo() {
        zzkn.m162v("AdMediaPlayerView audio focus gained");
        this.zzbww = true;
        zzoq();
    }

    private void zzop() {
        zzkn.m162v("AdMediaPlayerView audio focus lost");
        this.zzbww = false;
        zzoq();
    }
    ...
    private void zzz(boolean z) {
        zzkn.m162v("AdMediaPlayerView release");
        if (this.zzbwx != null) {
            this.zzbwx.zzpt();
            this.zzbwx = null;
        }
    ...
    public void onCompletion(MediaPlayer mediaPlayer) {
        zzkn.m162v("AdMediaPlayerView completion");
        zzaf(5);
        zzag(5);
    ...
    public boolean onInfo(MediaPlayer mediaPlayer, int i, int i2) {
        ...
        zzkn.m162v(new StringBuilder(String.valueOf(str).length() + 37 + String.valueOf(str2).length()).append("AdMediaPlayerView MediaPlayer info: ").append(str).append(":").append(str2).toString());
        return true;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        zzkn.m162v("AdMediaPlayerView prepared");
        zzaf(2);
        this.zzbwj.zzpj();
        zzkr.zzcrf.post(new Runnable() {
            public void run() {
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        zzkn.m162v("AdMediaPlayerView surface created");
        zzoh();
        zzkr.zzcrf.post(new Runnable() {
            public void run() {
                if (zzc.this.zzbxa != null) {
    ...
    public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        zzkn.m162v("AdMediaPlayerView surface destroyed");
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
        boolean z = true;
        zzkn.m162v("AdMediaPlayerView surface changed");
    ...
    public void onVideoSizeChanged(MediaPlayer mediaPlayer, int i, int i2) {
        zzkn.m162v(new StringBuilder(57).append("AdMediaPlayerView size changed: ").append(i).append(" x ").append(i2).toString());
        this.zzbwp = mediaPlayer.getVideoWidth();
        this.zzbwq = mediaPlayer.getVideoHeight();
    ...
    public void pause() {
        zzkn.m162v("AdMediaPlayerView pause");
    ...
    public void play() {
        zzkn.m162v("AdMediaPlayerView play");
        if (zzol()) {
            this.zzbwn.start();
            zzaf(3);
            zzkr.zzcrf.post(new Runnable() {
    ...
    public void seekTo(int i) {
        zzkn.m162v(new StringBuilder(34).append("AdMediaPlayerView seek ").append(i).toString());
        if (zzol()) {
            this.zzbwn.seekTo(i);
            this.zzbwz = 0;
            return;
    ...
    public void stop() {
        zzkn.m162v("AdMediaPlayerView stop");
        if (this.zzbwn != null) {
            this.zzbwn.stop();
            this.zzbwn.release();
            this.zzbwn = null;
