...
public interface zzl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzl {
        ...
        private static class C1085zza implements zzl {
            private IBinder zzajf;

            C1085zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzl zzbf(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzl)) ? new C1085zza(iBinder) : (zzl) queryLocalInterface;
        }
