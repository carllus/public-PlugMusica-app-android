...
public final class LargeParcelTeleporter extends AbstractSafeParcelable {
    ...
    public <T extends SafeParcelable> T zza(Parcelable.Creator<T> creator) {
        if (this.zzcig) {
            if (this.zzcie == null) {
                zzkn.m25e("File descriptor is empty, returning null.");
                return null;
            }
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        L_0x0043:
                            ...
                            goto L_0x0019
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.ads.internal.request.LargeParcelTeleporter.C04681.run():void");
                    }
                }).start();
                return createPipe[0];
            } catch (IOException e) {
