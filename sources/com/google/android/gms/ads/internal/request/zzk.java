...
public interface zzk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzk {
        ...
        private static class C1084zza implements zzk {
            private IBinder zzajf;

            C1084zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzk zzbe(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzk)) ? new C1084zza(iBinder) : (zzk) queryLocalInterface;
        }
