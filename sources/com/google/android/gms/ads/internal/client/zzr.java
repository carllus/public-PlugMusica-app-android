...
public interface zzr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzr {
        ...
        private static class C1073zza implements zzr {
            private IBinder zzajf;

            C1073zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzr zzn(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzr)) ? new C1073zza(iBinder) : (zzr) queryLocalInterface;
        }
