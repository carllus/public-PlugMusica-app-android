...
public final class zzk {
    ...
    public zzk(Context context, AttributeSet attributeSet) {
        boolean z = true;
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0417R.styleable.AdsAttrs);
        String string = obtainAttributes.getString(C0417R.styleable.AdsAttrs_adSize);
        String string2 = obtainAttributes.getString(C0417R.styleable.AdsAttrs_adSizes);
        ...
        this.zzang = obtainAttributes.getString(C0417R.styleable.AdsAttrs_adUnitId);
