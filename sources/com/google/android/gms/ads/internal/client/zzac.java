...
public interface zzac extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzac {
        ...
        private static class C1070zza implements zzac {
            private IBinder zzajf;

            C1070zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzac zzx(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzac)) ? new C1070zza(iBinder) : (zzac) queryLocalInterface;
        }
