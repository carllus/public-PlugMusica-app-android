...
public interface zzv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzv {
        ...
        private static class C1077zza implements zzv {
            private IBinder zzajf;

            C1077zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzv zzr(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzv)) ? new C1077zza(iBinder) : (zzv) queryLocalInterface;
        }
