...
public class zzaj extends zzs.zza {
    ...
    private class zza extends zzr.zza {
        ...
        public void zzf(AdRequestParcel adRequestParcel) throws RemoteException {
            zzb.m25e("This app is using a lightweight version of the Google Mobile Ads SDK that requires the latest Google Play services to be installed, but Google Play services is either missing or out of date.");
