...
public interface zzp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzp {
        ...
        private static class C1071zza implements zzp {
            private IBinder zzajf;

            C1071zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzp zzl(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzp)) ? new C1071zza(iBinder) : (zzp) queryLocalInterface;
        }
