...
public interface zzu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzu {
        ...
        private static class C1076zza implements zzu {
            private IBinder zzajf;

            C1076zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzu zzq(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzu)) ? new C1076zza(iBinder) : (zzu) queryLocalInterface;
        }
