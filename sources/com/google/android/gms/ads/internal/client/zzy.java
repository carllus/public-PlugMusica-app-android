...
public interface zzy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzy {
        ...
        private static class C1080zza implements zzy {
            private IBinder zzajf;

            C1080zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzy zzt(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzy)) ? new C1080zza(iBinder) : (zzy) queryLocalInterface;
        }
