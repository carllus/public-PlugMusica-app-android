...
public interface zzx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzx {
        ...
        private static class C1079zza implements zzx {
            private IBinder zzajf;

            C1079zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzx asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzx)) ? new C1079zza(iBinder) : (zzx) queryLocalInterface;
        }
