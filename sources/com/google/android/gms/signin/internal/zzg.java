...
public class zzg extends zzl<zze> implements zzwz {
    ...
    private ResolveAccountRequest zzcdj() {
        Account zzatv = this.f899xB.zzatv();
        GoogleSignInAccount googleSignInAccount = null;
        if ("<<default account>>".equals(zzatv.name)) {
            googleSignInAccount = zzk.zzbd(getContext()).zzaic();
        }
        return new ResolveAccountRequest(zzatv, this.f898Ca.intValue(), googleSignInAccount);
    }
    ...
    public void zza(zzr zzr, boolean z) {
        try {
            ((zze) zzatx()).zza(zzr, this.f898Ca.intValue(), z);
    ...
    public Bundle zzagl() {
        if (!getContext().getPackageName().equals(this.f899xB.zzauj())) {
            this.aAl.putString("com.google.android.gms.signin.internal.realClientPackageName", this.f899xB.zzauj());
        }
        return this.aAl;
    }
    ...
    public void zzcda() {
        try {
            ((zze) zzatx()).zzaaf(this.f898Ca.intValue());
        } catch (RemoteException e) {
