...
public interface zzhw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhw {
        ...
        private static class C1139zza implements zzhw {
        ...
        public static zzhw zzaw(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhw)) ? new C1139zza(iBinder) : (zzhw) queryLocalInterface;
        }
