...
public interface zzsd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzsd {
        ...
        private static class C1151zza implements zzsd {
            private IBinder zzajf;

            C1151zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzsd zzec(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzsd)) ? new C1151zza(iBinder) : (zzsd) queryLocalInterface;
        }
