...
public class zzse {
    ...
    /* renamed from: CR */
    private final String f858CR;

    /* renamed from: Dk */
    private final zzq f859Dk;

    /* renamed from: bX */
    private final int f860bX;
    private final String mTag;

    private zzse(String str, String str2) {
        this.f858CR = str2;
        this.mTag = str;
        this.f859Dk = new zzq(str);
        this.f860bX = getLogLevel();
    }
