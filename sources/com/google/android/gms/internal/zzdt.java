...
public interface zzdt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzdt {
        ...
        private static class C1119zza implements zzdt {
        ...
        public static zzdt zzz(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzdt)) ? new C1119zza(iBinder) : (zzdt) queryLocalInterface;
        }
