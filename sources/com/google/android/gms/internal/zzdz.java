...
public interface zzdz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzdz {
        ...
        private static class C1122zza implements zzdz {
        ...
        public static zzdz zzac(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzdz)) ? new C1122zza(iBinder) : (zzdz) queryLocalInterface;
        }
