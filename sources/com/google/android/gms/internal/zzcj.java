...
public abstract class zzcj implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    public void zzk(int r8) {
        ...
        L_0x0059:
            ...
            goto L_0x0010
        L_0x0063:
            org.json.JSONObject r0 = r7.zzd((android.view.View) r4)     // Catch:{ JSONException -> 0x007b, RuntimeException -> 0x0074 }
            r7.zza((org.json.JSONObject) r0)     // Catch:{ JSONException -> 0x007b, RuntimeException -> 0x0074 }
