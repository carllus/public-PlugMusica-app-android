...
public final class zzapw {
    ...
    public static final zzaot<Boolean> bmW = new zzaot<Boolean>() {
        ...
        public Boolean zzb(zzapy zzapy) throws IOException {
            if (zzapy.mo10201bn() != zzapz.NULL) {
                return zzapy.mo10201bn() == zzapz.STRING ? Boolean.valueOf(Boolean.parseBoolean(zzapy.nextString())) : Boolean.valueOf(zzapy.nextBoolean());
            }
            zzapy.nextNull();
            return null;
        }
    ...
    public static final zzaou bnC = new zzaou() {
        public <T> zzaot<T> zza(zzaob zzaob, zzapx<T> zzapx) {
            if (zzapx.mo10300by() != Timestamp.class) {
                return null;
            }
    ...
    public static final zzaot<Calendar> bnD = new zzaot<Calendar>() {
        ...
        public Calendar zzb(zzapy zzapy) throws IOException {
            ...
            int i5 = 0;
            int i6 = 0;
            while (zzapy.mo10201bn() != zzapz.END_OBJECT) {
    ...
    public static final zzaot<zzaoh> bnH = new zzaot<zzaoh>() {
        public void zza(zzaqa zzaqa, zzaoh zzaoh) throws IOException {
            if (zzaoh == null || zzaoh.mo10084aV()) {
                zzaqa.mo10223bx();
            } else if (zzaoh.mo10083aU()) {
                zzaon aY = zzaoh.mo10087aY();
                if (aY.mo10105bb()) {
                    zzaqa.zza(aY.mo10069aQ());
                } else if (aY.mo10104ba()) {
                    zzaqa.zzdf(aY.getAsBoolean());
                } else {
                    zzaqa.zzut(aY.mo10070aR());
                }
            } else if (zzaoh.mo10081aS()) {
                zzaqa.mo10219bt();
                Iterator<zzaoh> it = zzaoh.mo10086aX().iterator();
                while (it.hasNext()) {
                    zza(zzaqa, it.next());
                }
                zzaqa.mo10220bu();
            } else if (zzaoh.mo10082aT()) {
                zzaqa.mo10221bv();
                for (Map.Entry next : zzaoh.mo10085aW().entrySet()) {
        ...
        public zzaoh zzb(zzapy zzapy) throws IOException {
            switch (C061826.bmF[zzapy.mo10201bn().ordinal()]) {
                case 1:
    ...
    public static final zzaou bnJ = new zzaou() {
        ...
        public <T> com.google.android.gms.internal.zzaot<T> zza(com.google.android.gms.internal.zzaob r3, com.google.android.gms.internal.zzapx<T> r4) {
            /*
                r2 = this;
                java.lang.Class r0 = r4.mo10300by()
            ...
            L_0x001c:
                ...
                goto L_0x0011
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzapw.C061019.zza(com.google.android.gms.internal.zzaob, com.google.android.gms.internal.zzapx):com.google.android.gms.internal.zzaot");
        }
    };
        ...
        public zza(Class<T> cls) {
            try {
                for (Enum enumR : (Enum[]) cls.getEnumConstants()) {
                    ...
                    if (zzaow != null) {
                        name = zzaow.value();
                        for (String put : zzaow.mo10113be()) {
    ...
    public static <TT> zzaou zzb(final Class<TT> cls, final zzaot<TT> zzaot) {
        return new zzaou() {
            ...
            public <T> zzaot<T> zza(zzaob zzaob, zzapx<T> zzapx) {
                if (cls.isAssignableFrom(zzapx.mo10300by())) {
                    return zzaot;
                }
                return null;
            }
