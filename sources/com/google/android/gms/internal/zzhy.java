...
public interface zzhy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhy {
        ...
        private static class C1141zza implements zzhy {
            private IBinder zzajf;

            C1141zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzhy zzay(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhy)) ? new C1141zza(iBinder) : (zzhy) queryLocalInterface;
        }
