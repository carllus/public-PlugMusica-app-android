...
public interface zzsc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzsc {
        ...
        private static class C1150zza implements zzsc {
            private IBinder zzajf;

            C1150zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzsc zzeb(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzsc)) ? new C1150zza(iBinder) : (zzsc) queryLocalInterface;
        }
