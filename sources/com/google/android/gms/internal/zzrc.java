...
public final class zzrc extends Fragment implements zzrb {
    ...
    /* renamed from: yZ */
    private static WeakHashMap<Activity, WeakReference<zzrc>> f787yZ = new WeakHashMap<>();

    /* renamed from: za */
    private Map<String, zzra> f788za = new ArrayMap();
    /* access modifiers changed from: private */

    /* renamed from: zb */
    public Bundle f789zb;
    /* access modifiers changed from: private */
    public int zzbqm = 0;
            ...
            new Handler(Looper.getMainLooper()).post(new Runnable() {
                public void run() {
                    if (zzrc.this.zzbqm >= 1) {
                        zzra.onCreate(zzrc.this.f789zb != null ? zzrc.this.f789zb.getBundle(str) : null);
                    }
    ...
    public static zzrc zzt(Activity activity) {
        zzrc zzrc;
        WeakReference weakReference = f787yZ.get(activity);
        if (weakReference == null || (zzrc = (zzrc) weakReference.get()) == null) {
            try {
                ...
                f787yZ.put(activity, new WeakReference(zzrc));
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        for (zzra dump : this.f788za.values()) {
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        for (zzra onActivityResult : this.f788za.values()) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.zzbqm = 1;
        this.f789zb = bundle;
        for (Map.Entry next : this.f788za.entrySet()) {
    ...
    public void onDestroy() {
        super.onStop();
        this.zzbqm = 4;
        for (zzra onDestroy : this.f788za.values()) {
            onDestroy.onDestroy();
        }
    }
    ...
    public void onStart() {
        super.onStop();
        this.zzbqm = 2;
        for (zzra onStart : this.f788za.values()) {
            onStart.onStart();
        }
    }
    ...
    public void onStop() {
        super.onStop();
        this.zzbqm = 3;
        for (zzra onStop : this.f788za.values()) {
            onStop.onStop();
        }
    }

    public <T extends zzra> T zza(String str, Class<T> cls) {
        return (zzra) cls.cast(this.f788za.get(str));
    }

    public void zza(String str, @NonNull zzra zzra) {
        if (!this.f788za.containsKey(str)) {
            this.f788za.put(str, zzra);
            zzb(str, zzra);
            return;
        }
