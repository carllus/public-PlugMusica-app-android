...
public class zzku {
    ...
    private void zzur() {
        ...
        new AlertDialog.Builder(this.mContext).setTitle(resources != null ? resources.getString(C0417R.string.debug_menu_title) : "Select a Debug Mode").setItems(new String[]{resources != null ? resources.getString(C0417R.string.debug_menu_ad_information) : "Ad Information", resources != null ? resources.getString(C0417R.string.debug_menu_creative_preview) : "Creative Preview", resources != null ? resources.getString(C0417R.string.debug_menu_troubleshooting) : "Troubleshooting"}, new DialogInterface.OnClickListener() {
