...
public interface zzdx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzdx {
        ...
        private static class C1121zza implements zzdx {
            private IBinder zzajf;

            C1121zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzdx zzab(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzdx)) ? new C1121zza(iBinder) : (zzdx) queryLocalInterface;
        }
