...
public interface zzej extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzej {
        ...
        private static class C1129zza implements zzej {
            private IBinder zzajf;

            C1129zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzej zzaj(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzej)) ? new C1129zza(iBinder) : (zzej) queryLocalInterface;
        }
