...
public interface zzed extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzed {
        ...
        private static class C1125zza implements zzed {
        ...
        public static zzed zzaf(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzed)) ? new C1125zza(iBinder) : (zzed) queryLocalInterface;
        }
