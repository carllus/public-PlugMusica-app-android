...
public class zzs {
    ...
    static class zza {
        ...
        private final List<C1149zza> zzbk = new ArrayList();
        ...
        private static class C1149zza {
            public final String name;
            public final long time;
            public final long zzbm;

            public C1149zza(String str, long j, long j2) {
                this.name = str;
                this.zzbm = j;
                this.time = j2;
            }
        ...
        public synchronized void zza(String str, long j) {
            ...
            this.zzbk.add(new C1149zza(str, j, SystemClock.elapsedRealtime()));
        }
