                ...
                if (!this.zzbra) {
                    ...
                    zza(new zzlm.zzc<zzfz>() {
                        ...
                        public void zzd(zzfz zzfz) {
                            zzkn.m162v("Ending javascript session.");
                            ((zzga) zzfz).zznd();
                        }
                    }, new zzlm.zzb());
                    zza(new zzlm.zzc<zzfz>() {
                        /* renamed from: zzb */
                        public void zzd(zzfz zzfz) {
                            zzkn.m162v("Releasing engine reference.");
                            zzc.this.zzbqz.zzna();
                        }
                    }, new zzlm.zza() {
                        public void run() {
    ...
    public static class zzd extends zzln<zzfv> {
            ...
            synchronized (this.zzakd) {
                zza(new zzlm.zzc<zzfv>() {
                    ...
                    public void zzd(zzfv zzfv) {
                        zzkn.m162v("Getting a new session for JS Engine.");
                        zzc.zzg(zzfv.zzmw());
                    }
                }, new zzlm.zza() {
                    public void run() {
                        zzkn.m162v("Rejecting reference for JS Engine.");
                        zzc.reject();
                    }
                });
        ...
        public void zzna() {
            ...
            synchronized (this.zzakd) {
                ...
                zzac.zzbr(z);
                zzkn.m162v("Releasing 1 reference for JS Engine");
                this.zzbrd--;
                zznc();
            }
        }
        ...
        public void zznb() {
            ...
            synchronized (this.zzakd) {
                ...
                zzac.zzbr(z);
                zzkn.m162v("Releasing root reference. JS Engine will be destroyed once other references are released.");
                this.zzbrc = true;
                zznc();
            }
        }
        ...
        public void zznc() {
            synchronized (this.zzakd) {
                ...
                if (!this.zzbrc || this.zzbrd != 0) {
                    zzkn.m162v("There are still references to the engine. Not destroying.");
                } else {
                    zzkn.m162v("No reference is left (including root). Cleaning up engine.");
                    zza(new zzlm.zzc<zzfv>() {
                        /* renamed from: zza */
                    ...
                    public void zzmx() {
                        zzkr.zzcrf.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                /*
                                    r3 = this;
                                    com.google.android.gms.internal.zzfy$1$1 r0 = com.google.android.gms.internal.zzfy.C07161.C07171.this
                                    com.google.android.gms.internal.zzfy$1 r0 = com.google.android.gms.internal.zzfy.C07161.this
                                    com.google.android.gms.internal.zzfy r0 = com.google.android.gms.internal.zzfy.this
                                    java.lang.Object r1 = r0.zzakd
                                    monitor-enter(r1)
                                    com.google.android.gms.internal.zzfy$1$1 r0 = com.google.android.gms.internal.zzfy.C07161.C07171.this     // Catch:{ all -> 0x0043 }
                                    com.google.android.gms.internal.zzfy$1 r0 = com.google.android.gms.internal.zzfy.C07161.this     // Catch:{ all -> 0x0043 }
                                ...
                                L_0x0027:
                                    ...
                                    com.google.android.gms.internal.zzkn.m162v(r0)     // Catch:{ all -> 0x0043 }
                                    monitor-exit(r1)     // Catch:{ all -> 0x0043 }
                                    goto L_0x0026
                                L_0x0043:
                                    r0 = move-exception
                                    ...
                                    throw r0
                                */
                                throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzfy.C07161.C07171.C07181.run():void");
                            }
                        }, (long) zza.zzbqy);
                    }
                });
                zza.zza("/jsLoaded", (zzev) new zzev() {
                    ...
                    public void zza(com.google.android.gms.internal.zzlt r4, java.util.Map<java.lang.String, java.lang.String> r5) {
                        /*
                            ...
                            java.lang.Object r1 = r0.zzakd
                            monitor-enter(r1)
                            com.google.android.gms.internal.zzfy$1 r0 = com.google.android.gms.internal.zzfy.C07161.this     // Catch:{ all -> 0x0051 }
                        ...
                        L_0x0021:
                            ...
                            com.google.android.gms.internal.zzfy$1 r0 = com.google.android.gms.internal.zzfy.C07161.this     // Catch:{ all -> 0x0051 }
                            com.google.android.gms.internal.zzfy r0 = com.google.android.gms.internal.zzfy.this     // Catch:{ all -> 0x0051 }
                            com.google.android.gms.internal.zzfy$1 r2 = com.google.android.gms.internal.zzfy.C07161.this     // Catch:{ all -> 0x0051 }
                            ...
                            com.google.android.gms.internal.zzkn.m162v(r0)     // Catch:{ all -> 0x0051 }
                            monitor-exit(r1)     // Catch:{ all -> 0x0051 }
                            goto L_0x0020
                        L_0x0051:
                            r0 = move-exception
                            ...
                            throw r0
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzfy.C07161.C07202.zza(com.google.android.gms.internal.zzlt, java.util.Map):void");
                    }
                });
                ...
                zzkr.zzcrf.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        /*
                            ...
                            java.lang.Object r1 = r0.zzakd
                            monitor-enter(r1)
                            com.google.android.gms.internal.zzfy$1 r0 = com.google.android.gms.internal.zzfy.C07161.this     // Catch:{ all -> 0x003b }
                        ...
                        L_0x0021:
                            ...
                            java.lang.String r0 = "Could not receive loaded message in a timely manner. Rejecting."
                            com.google.android.gms.internal.zzkn.m162v(r0)     // Catch:{ all -> 0x003b }
                            monitor-exit(r1)     // Catch:{ all -> 0x003b }
                            goto L_0x0020
                        L_0x003b:
                            r0 = move-exception
                            ...
                            throw r0
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzfy.C07161.C07224.run():void");
                    }
                }, (long) zza.zzbqx);
            }
        });
        ...
        zza2.zza(new zzlm.zzc<zzfv>() {
            ...
            public void zzd(zzfv zzfv) {
                synchronized (zzfy.this.zzakd) {
                    ...
                    if (!(zzfy.this.zzbql == null || zza2 == zzfy.this.zzbql)) {
                        zzkn.m162v("New JS engine is loaded, marking previous one as destroyable.");
            ...
            public void run() {
                synchronized (zzfy.this.zzakd) {
                    ...
                    zzkn.m162v("Failed loading new engine. Marking new engine destroyable.");
                    zza2.zznb();
                }
            }
        });
