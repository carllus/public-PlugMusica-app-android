...
public class zzkr {
    ...
    public void zza(final Context context, @Nullable final String str, String str2, Bundle bundle, boolean z) {
        ...
        zzm.zzjr().zza(context, str, str2, bundle, z, new zza.C1093zza() {
    ...
    public void zza(final Context context, final List<String> list) {
        ...
        if (list == null) {
            zzkn.m162v("Cannot ping urls: empty list.");
        } else if (!zzdw.zzo(context)) {
            zzkn.m162v("Cannot ping url because custom tabs is not supported");
        } else {
