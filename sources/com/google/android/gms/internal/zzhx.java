...
public interface zzhx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhx {
        ...
        private static class C1140zza implements zzhx {
        ...
        public static zzhx zzax(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhx)) ? new C1140zza(iBinder) : (zzhx) queryLocalInterface;
        }
