...
public interface zzgs extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgs {
        ...
        private static class C1133zza implements zzgs {
        ...
        public static zzgs zzao(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzgs)) ? new C1133zza(iBinder) : (zzgs) queryLocalInterface;
        }
