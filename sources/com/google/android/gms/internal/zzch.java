...
public interface zzch extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzch {
        ...
        private static class C1117zza implements zzch {
        ...
        public static zzch zze(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzch)) ? new C1117zza(iBinder) : (zzch) queryLocalInterface;
        }
