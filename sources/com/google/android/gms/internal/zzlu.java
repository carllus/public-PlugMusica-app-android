...
public class zzlu extends WebViewClient {
    ...
    public final void onLoadResource(WebView webView, String str) {
        ...
        zzkn.m162v(valueOf.length() != 0 ? "Loading resource: ".concat(valueOf) : new String("Loading resource: "));
        Uri parse = Uri.parse(str);
    ...
    public final void onPageFinished(WebView webView, String str) {
        synchronized (this.zzakd) {
            if (this.zzcvh) {
                zzkn.m162v("Blank page loaded, 1...");
                this.zzbkr.zzvw();
                return;
            }
            this.zzcvi = true;
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        Uri uri;
        String valueOf = String.valueOf(str);
        zzkn.m162v(valueOf.length() != 0 ? "AdWebView shouldOverrideUrlLoading: ".concat(valueOf) : new String("AdWebView shouldOverrideUrlLoading: "));
        Uri parse = Uri.parse(str);
        if ("gmsg".equalsIgnoreCase(parse.getScheme()) && "mobileads.google.com".equalsIgnoreCase(parse.getHost())) {
            zzj(parse);
    ...
    public void zzj(Uri uri) {
        ...
        if (list != null) {
            ...
            if (zzkn.zzbf(2)) {
                ...
                zzkn.m162v(valueOf.length() != 0 ? "Received GMSG: ".concat(valueOf) : new String("Received GMSG: "));
                for (String next : zzg.keySet()) {
                    String str = zzg.get(next);
                    zzkn.m162v(new StringBuilder(String.valueOf(next).length() + 4 + String.valueOf(str).length()).append("  ").append(next).append(": ").append(str).toString());
                }
            }
            for (zzev zza2 : list) {
        ...
        zzkn.m162v(new StringBuilder(String.valueOf(valueOf2).length() + 32).append("No GMSG handler found for GMSG: ").append(valueOf2).toString());
    }
    ...
    public void zzwn() {
        synchronized (this.zzakd) {
            zzkn.m162v("Loading blank page in WebView, 2...");
            this.zzcvh = true;
