...
public interface zzqx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzqx {
        ...
        private static class C1147zza implements zzqx {
        ...
        public static zzqx zzdp(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzqx)) ? new C1147zza(iBinder) : (zzqx) queryLocalInterface;
        }
