...
public class zzxb {
    ...
    /* renamed from: EA */
    private final String f891EA;

    /* renamed from: Ey */
    private final String f892Ey;
    ...
    public zzxb(Context context, int i, String str, String str2, String str3, String str4) {
        ...
        if (!"com.google.android.gms".equals(context.getPackageName())) {
            ...
            this.f892Ey = valueOf2.length() != 0 ? valueOf.concat(valueOf2) : new String(valueOf);
        } else {
            this.f892Ey = str;
        }
    ...
    private void zzm(java.lang.String r13, long r14) {
        ...
        L_0x001f:
            ...
            r4 = 7
            java.lang.String r5 = r12.f892Ey     // Catch:{ all -> 0x0044 }
            java.lang.String r7 = r12.f891EA     // Catch:{ all -> 0x0044 }
    ...
    private void zzoo(java.lang.String r10) {
        ...
        L_0x0020:
            ...
            r3 = 8
            java.lang.String r4 = r9.f892Ey     // Catch:{ all -> 0x0045 }
            java.lang.String r6 = r9.f891EA     // Catch:{ all -> 0x0045 }
    ...
    public void acquire(long j) {
        if (!zzs.zzaxn() && this.aAs) {
            String str = TAG;
            String valueOf = String.valueOf(this.f892Ey);
