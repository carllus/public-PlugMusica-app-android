...
public final class zzwy {
    public static final Api<zzxa> API = new Api<>("SignIn.API", f884fb, f883fa);

    /* renamed from: Hp */
    public static final Api<zza> f882Hp = new Api<>("SignIn.INTERNAL_API", azZ, azY);
    ...
    /* renamed from: fa */
    public static final Api.zzf<zzg> f883fa = new Api.zzf<>();

    /* renamed from: fb */
    public static final Api.zza<zzg, zzxa> f884fb = new Api.zza<zzg, zzxa>() {
    ...
    /* renamed from: hd */
    public static final Scope f885hd = new Scope(Scopes.PROFILE);

    /* renamed from: he */
    public static final Scope f886he = new Scope("email");
