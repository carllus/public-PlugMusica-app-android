...
public class zzaqa implements Closeable, Flushable {
    ...
    /* renamed from: bM */
    private void m94bM() throws IOException {
        if (this.boy != null) {
            m96bO();
            zzuw(this.boy);
            this.boy = null;
    ...
    /* renamed from: bN */
    private void m95bN() throws IOException {
        if (this.box != null) {
            this.out.write("\n");
            int i = this.boh;
    ...
    /* renamed from: bO */
    private void m96bO() throws IOException {
        int bL = m93bL();
        if (bL == 5) {
            this.out.write(44);
        } else if (bL != 3) {
    ...
    /* renamed from: bJ */
    public final boolean mo10313bJ() {
        return this.bkO;
    }

    /* renamed from: bK */
    public final boolean mo10314bK() {
        return this.bkN;
    }
