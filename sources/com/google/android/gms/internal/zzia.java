...
public interface zzia extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzia {
        ...
        private static class C1143zza implements zzia {
        ...
        public static zzia zzba(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzia)) ? new C1143zza(iBinder) : (zzia) queryLocalInterface;
        }
