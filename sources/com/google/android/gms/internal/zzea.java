...
public interface zzea extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzea {
        ...
        private static class C1123zza implements zzea {
        ...
        public static zzea zzad(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzea)) ? new C1123zza(iBinder) : (zzea) queryLocalInterface;
        }
