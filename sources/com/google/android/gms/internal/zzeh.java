...
public interface zzeh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzeh {
        ...
        private static class C1127zza implements zzeh {
            private IBinder zzajf;

            C1127zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzeh zzah(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzeh)) ? new C1127zza(iBinder) : (zzeh) queryLocalInterface;
        }
