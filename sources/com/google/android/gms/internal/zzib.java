...
public interface zzib extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzib {
        ...
        private static class C1144zza implements zzib {
            private IBinder zzajf;

            C1144zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzib zzbb(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzib)) ? new C1144zza(iBinder) : (zzib) queryLocalInterface;
        }
