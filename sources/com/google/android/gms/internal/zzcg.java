...
public interface zzcg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcg {
        ...
        private static class C1116zza implements zzcg {
            private IBinder zzajf;

            C1116zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzcg zzd(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzcg)) ? new C1116zza(iBinder) : (zzcg) queryLocalInterface;
        }
