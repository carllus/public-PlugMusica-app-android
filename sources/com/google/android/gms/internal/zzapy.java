...
public class zzapy implements Closeable {
        ...
        zzapd.blQ = new zzapd() {
            public void zzi(zzapy zzapy) throws IOException {
                ...
                if (zzag == 13) {
                    ...
                    String valueOf = String.valueOf(zzapy.mo10201bn());
    ...
    /* access modifiers changed from: private */
    /* renamed from: bA */
    public int m83bA() throws IOException {
    ...
    /* renamed from: bB */
    private int m84bB() throws IOException {
        String str;
        String str2;
        int i;
    ...
    private int m85bC() throws java.io.IOException {
        /*
            r15 = this;
            char[] r11 = r15.bnZ
            int r2 = r15.pos
    ...
    /* renamed from: bD */
    private String m86bD() throws IOException {
        String sb;
    ...
    /* renamed from: bE */
    private void m87bE() throws IOException {
        do {
            int i = 0;
    ...
    /* renamed from: bF */
    private void m88bF() throws IOException {
        if (!this.bnY) {
    ...
    /* renamed from: bG */
    private void m89bG() throws IOException {
        char c;
        do {
    ...
    /* renamed from: bH */
    private char m90bH() throws IOException {
        int i;
        if (this.pos != this.limit || zzagx(1)) {
            char[] cArr = this.bnZ;
            int i2 = this.pos;
    ...
    /* renamed from: bI */
    private void m91bI() throws IOException {
        zzdg(true);
        this.pos--;
    ...
    private boolean zzagx(int i) throws IOException {
        ...
        this.pos = 0;
        do {
            int read = this.f551in.read(cArr, this.limit, cArr.length - this.limit);
            if (read == -1) {
                return false;
            }
    ...
    public void beginArray() throws IOException {
        ...
        String valueOf = String.valueOf(mo10201bn());
        int lineNumber = getLineNumber();
        int columnNumber = getColumnNumber();
        String path = getPath();
