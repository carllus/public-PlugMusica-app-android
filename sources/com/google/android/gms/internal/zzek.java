...
public interface zzek extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzek {
        ...
        private static class C1130zza implements zzek {
        ...
        public static zzek zzak(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzek)) ? new C1130zza(iBinder) : (zzek) queryLocalInterface;
        }
