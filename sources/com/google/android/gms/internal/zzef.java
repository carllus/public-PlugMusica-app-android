...
public interface zzef extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzef {
        ...
        private static class C1126zza implements zzef {
        ...
        public static zzef zzag(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzef)) ? new C1126zza(iBinder) : (zzef) queryLocalInterface;
        }
