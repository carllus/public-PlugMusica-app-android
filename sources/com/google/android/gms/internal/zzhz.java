...
public interface zzhz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhz {
        ...
        private static class C1142zza implements zzhz {
        ...
        public static zzhz zzaz(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhz)) ? new C1142zza(iBinder) : (zzhz) queryLocalInterface;
        }
