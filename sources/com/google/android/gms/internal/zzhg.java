...
public class zzhg extends zzhm {
    ...
    public void execute() {
        if (this.mContext == null) {
            ...
            zzaf.setTitle(resources != null ? resources.getString(C0417R.string.create_calendar_title) : "Create calendar event");
            zzaf.setMessage(resources != null ? resources.getString(C0417R.string.create_calendar_message) : "Allow Ad to create a calendar event?");
            zzaf.setPositiveButton(resources != null ? resources.getString(C0417R.string.accept) : "Accept", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
                    zzu.zzfz().zzb(zzhg.this.mContext, zzhg.this.createIntent());
                }
            });
            zzaf.setNegativeButton(resources != null ? resources.getString(C0417R.string.decline) : "Decline", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
