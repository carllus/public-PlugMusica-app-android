...
public interface zzei extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzei {
        ...
        private static class C1128zza implements zzei {
            private IBinder zzajf;

            C1128zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzei zzai(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzei)) ? new C1128zza(iBinder) : (zzei) queryLocalInterface;
        }
