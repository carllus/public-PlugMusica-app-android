...
public interface zzsv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzsv {
        ...
        private static class C1153zza implements zzsv {
            private IBinder zzajf;

            C1153zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzsv zzff(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzsv)) ? new C1153zza(iBinder) : (zzsv) queryLocalInterface;
        }
