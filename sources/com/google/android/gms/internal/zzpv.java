...
public interface zzpv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzpv {
        ...
        private static class C1146zza implements zzpv {
        ...
        public static zzpv zzdo(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzpv)) ? new C1146zza(iBinder) : (zzpv) queryLocalInterface;
        }
