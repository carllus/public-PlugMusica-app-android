    ...
    public void execute() {
        if (this.mContext == null) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                zzaf.setTitle(resources != null ? resources.getString(C0417R.string.store_picture_title) : "Save image");
                zzaf.setMessage(resources != null ? resources.getString(C0417R.string.store_picture_message) : "Allow Ad to store image in Picture gallery?");
