...
public final class zzrn extends Fragment implements zzrb {
    ...
    /* renamed from: yZ */
    private static WeakHashMap<FragmentActivity, WeakReference<zzrn>> f803yZ = new WeakHashMap<>();

    /* renamed from: za */
    private Map<String, zzra> f804za = new ArrayMap();
    /* access modifiers changed from: private */

    /* renamed from: zb */
    public Bundle f805zb;
    /* access modifiers changed from: private */
    public int zzbqm = 0;

    public static zzrn zza(FragmentActivity fragmentActivity) {
        zzrn zzrn;
        WeakReference weakReference = f803yZ.get(fragmentActivity);
        if (weakReference == null || (zzrn = (zzrn) weakReference.get()) == null) {
            try {
                ...
                f803yZ.put(fragmentActivity, new WeakReference(zzrn));
            ...
            new Handler(Looper.getMainLooper()).post(new Runnable() {
                public void run() {
                    if (zzrn.this.zzbqm >= 1) {
                        zzra.onCreate(zzrn.this.f805zb != null ? zzrn.this.f805zb.getBundle(str) : null);
                    }
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        for (zzra dump : this.f804za.values()) {
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        for (zzra onActivityResult : this.f804za.values()) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.zzbqm = 1;
        this.f805zb = bundle;
        for (Map.Entry next : this.f804za.entrySet()) {
    ...
    public void onDestroy() {
        super.onStop();
        this.zzbqm = 4;
        for (zzra onDestroy : this.f804za.values()) {
            onDestroy.onDestroy();
        }
    }
    ...
    public void onStart() {
        super.onStop();
        this.zzbqm = 2;
        for (zzra onStart : this.f804za.values()) {
            onStart.onStart();
        }
    }
    ...
    public void onStop() {
        super.onStop();
        this.zzbqm = 3;
        for (zzra onStop : this.f804za.values()) {
            onStop.onStop();
        }
    }

    public <T extends zzra> T zza(String str, Class<T> cls) {
        return (zzra) cls.cast(this.f804za.get(str));
    }

    public void zza(String str, @NonNull zzra zzra) {
        if (!this.f804za.containsKey(str)) {
            this.f804za.put(str, zzra);
            zzb(str, zzra);
            return;
        }
