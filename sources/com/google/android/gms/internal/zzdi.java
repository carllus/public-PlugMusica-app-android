...
public final class zzdi {
    ...
    public static final zzde<Integer> zzbbf = zzde.zza(1, "gads:video_stream_cache:limit_space", (int) GravityCompat.RELATIVE_LAYOUT_DIRECTION);
    public static final zzde<Integer> zzbbg = zzde.zza(1, "gads:video_stream_exo_allocator:segment_size", 65536);
    public static final zzde<Integer> zzbbh = zzde.zza(1, "gads:video_stream_exo_cache:buffer_size", (int) GravityCompat.RELATIVE_LAYOUT_DIRECTION);
