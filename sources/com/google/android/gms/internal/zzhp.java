...
public interface zzhp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhp {
        ...
        private static class C1137zza implements zzhp {
        ...
        public static zzhp zzat(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhp)) ? new C1137zza(iBinder) : (zzhp) queryLocalInterface;
        }
