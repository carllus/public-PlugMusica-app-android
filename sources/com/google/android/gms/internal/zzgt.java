...
public interface zzgt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgt {
        ...
        private static class C1134zza implements zzgt {
            private IBinder zzajf;

            C1134zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzgt zzap(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzgt)) ? new C1134zza(iBinder) : (zzgt) queryLocalInterface;
        }
