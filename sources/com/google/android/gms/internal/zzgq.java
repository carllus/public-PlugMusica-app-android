...
public interface zzgq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgq {
        ...
        private static class C1131zza implements zzgq {
        ...
        public static zzgq zzam(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzgq)) ? new C1131zza(iBinder) : (zzgq) queryLocalInterface;
        }
