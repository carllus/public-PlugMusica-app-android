...
public interface zzhq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhq {
        ...
        private static class C1138zza implements zzhq {
            private IBinder zzajf;

            C1138zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzhq zzau(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhq)) ? new C1138zza(iBinder) : (zzhq) queryLocalInterface;
        }
