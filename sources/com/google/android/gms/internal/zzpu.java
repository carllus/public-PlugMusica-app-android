...
public interface zzpu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzpu {
        ...
        private static class C1145zza implements zzpu {
        ...
        public static zzpu zzdn(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzpu)) ? new C1145zza(iBinder) : (zzpu) queryLocalInterface;
        }
