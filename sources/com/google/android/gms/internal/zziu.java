...
public class zziu implements zzis.zza<zzd> {
    ...
    public zzd zza(zzis zzis, JSONObject jSONObject) throws JSONException, InterruptedException, ExecutionException {
        ...
        zzlt zzb = zzb(zzc);
        return new zzd(jSONObject.getString("headline"), arrayList, jSONObject.getString("body"), (zzdx) zza2.get(), jSONObject.getString("call_to_action"), jSONObject.optDouble("rating", -1.0d), jSONObject.optString("store"), jSONObject.optString("price"), (zza) zzg.get(), new Bundle(), zzb != null ? zzb.zzwb() : null, zzb != null ? zzb.getView() : null);
    }
}
