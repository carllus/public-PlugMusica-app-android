...
public class zzd implements Parcelable.Creator<LogEventParcelable> {
    static void zza(LogEventParcelable logEventParcelable, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 2, (Parcelable) logEventParcelable.f76uc, i, false);
        zzb.zza(parcel, 3, logEventParcelable.f77ud, false);
        zzb.zza(parcel, 4, logEventParcelable.f78ue, false);
        zzb.zza(parcel, 5, logEventParcelable.f79uf, false);
        zzb.zza(parcel, 6, logEventParcelable.f80ug, false);
        zzb.zza(parcel, 7, logEventParcelable.f81uh, false);
        zzb.zza(parcel, 8, logEventParcelable.f82ui);
