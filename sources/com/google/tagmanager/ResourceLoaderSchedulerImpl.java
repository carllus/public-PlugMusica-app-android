...
class ResourceLoaderSchedulerImpl implements Container.ResourceLoaderScheduler {
    ...
    public synchronized void setLoadCallback(LoadCallback<Serving.SupplementedResource> callback) {
        ensureNotClosed();
        this.mCallback = callback;
    }

    public synchronized void loadAfterDelay(long delayInMillis, String previousVersion) {
        Log.m179v("loadAfterDelay: containerId=" + this.mContainerId + " delay=" + delayInMillis);
        ensureNotClosed();
