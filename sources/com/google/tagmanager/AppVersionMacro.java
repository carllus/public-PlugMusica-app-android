...
class AppVersionMacro extends FunctionCallImplementation {
    ...
    /* renamed from: ID */
    private static final String f905ID = FunctionType.APP_VERSION.toString();
    ...
    public TypeSystem.Value evaluate(Map<String, TypeSystem.Value> map) {
        try {
            ...
            Log.m175e("Package name " + this.mContext.getPackageName() + " not found. " + e.getMessage());
