...
class ArbitraryPixelTag extends TrackingTag {
    ...
    static final String ARBITRARY_PIXEL_UNREPEATABLE = ("gtm_" + f906ID + "_unrepeatable");

    /* renamed from: ID */
    private static final String f906ID = FunctionType.ARBITRARY_PIXEL.toString();
        ...
        if (unrepeatableId == null || !idProcessed(unrepeatableId)) {
            ...
            if (additionalParamsList != null) {
                ...
                if (!(l instanceof List)) {
                    Log.m175e("ArbitraryPixel: additional params not a list: not sending partial hit: " + uriBuilder.build().toString());
                    return;
                }
                for (Object m : (List) l) {
                    if (!(m instanceof Map)) {
                        Log.m175e("ArbitraryPixel: additional params contains non-map: not sending partial hit: " + uriBuilder.build().toString());
                        return;
                    }
            ...
            Log.m179v("ArbitraryPixel: url = " + uri);
