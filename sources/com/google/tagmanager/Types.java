...
class Types {
    ...
    public static TypeSystem.Value objectToValue(Object o) {
        ...
        if (o instanceof String) {
            ...
            Log.m175e("Converting to Value from unknown object type: " + (o == null ? "null" : o.getClass().toString()));
            return DEFAULT_VALUE;
        }
    ...
    private static double getDouble(Object o) {
        ...
        Log.m175e("getDouble received non-Number");
        return 0.0d;
    }
    ...
    private static long getInt64(Object o) {
        ...
        Log.m175e("getInt64 received non-Number");
        return 0;
    }
    ...
    private static TypedNumber parseNumber(String s) {
        try {
            ...
            Log.m175e("Failed to convert '" + s + "' to a number.");
            return DEFAULT_NUMBER;
        }
    }
        ...
        switch (v.type) {
            ...
            case 3:
                if (v.mapKey.length != v.mapValue.length) {
                    Log.m175e("Converting an invalid value to object: " + v.toString());
                    return DEFAULT_OBJECT;
                }
                ...
                return result2;
            case 4:
                Log.m175e("Trying to convert a macro reference to object");
                return DEFAULT_OBJECT;
            case 5:
                Log.m175e("Trying to convert a function id to object");
                return DEFAULT_OBJECT;
            case 6:
            ...
            default:
                Log.m175e("Failed to convert a value of type: " + v.type);
                return DEFAULT_OBJECT;
        }
    }
}
